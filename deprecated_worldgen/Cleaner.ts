import { world, system, BlockVolume, BlockPermutation, Dimension, Vector3, BlockComponentRegistry, BlockCustomComponent } from "@minecraft/server"
...
const CLUTTER_TYPES: string[] = ["minecraft:deadbush", "minecraft:snow_layer", "minecraft:sugar_cane", "minecraft:bamboo", "minecraft:kelp", "minecraft:glow_lichen"];
...
let AIR: BlockPermutation | undefined;
let DIM: Dimension | undefined;
let SHARED_VOL: BlockVolume | undefined;
const QUEUE: QueueItem[] = [];
const CACHE: Set<number> = new Set();
const QUEUED: Set<number> = new Set();
...
export function registerCleanerComponent({ blockComponentRegistry }: { blockComponentRegistry: BlockComponentRegistry }): void {
