...
interface NativeRecipe {
    output?: string;
    outputBlockState?: Record<string, string | number | boolean>;
    blockState?: Record<string, string | number | boolean>;
    scriptedOutput?: (item: MC.ItemStack) => MC.ItemStack | undefined;
}
...
export const nativeRecipes: Record<string, NativeRecipe> = {
    "minecraft:raw_iron":{
...
export const nativeFuels: Record<string, number | FuelData> = {
