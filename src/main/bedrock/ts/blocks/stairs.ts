...
interface StairShape {
    half: string | number | boolean | undefined;
    direction: string | number | boolean | undefined;
}
...
function updateStair(block: Block): void {
    ...
    try {
        ...
        const validNeighbor = (neighbor: Block | undefined, dir: string): boolean => {
...
export function registerStairsComponent({ blockComponentRegistry }: { blockComponentRegistry: BlockComponentRegistry }): void {
