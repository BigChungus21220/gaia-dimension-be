...
import { BlockPermutation, system, world, BlockVolume, Dimension } from "@minecraft/server";
...
let the_end: Dimension | undefined;
let air: BlockPermutation | undefined;
let clearFilter: string[] = [];
const queue: Task[] = [];
const clearedSlices = new Set<string>();
