...
world.beforeEvents.worldInitialize.subscribe(eventData => {
    ...
    eventData.blockComponentRegistry.registerCustomComponent('gaia:purple_agate_log', {
        ...
        onPlayerInteract(e) {
            ...
            if (blockState) {
                const strippedLog = BlockPermutation.resolve('gaia:stripped_purple_agate_log', {"minecraft:block_face": blockState});
