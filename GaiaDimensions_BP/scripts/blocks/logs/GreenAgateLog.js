...
world.beforeEvents.worldInitialize.subscribe(eventData => {
    ...
    eventData.blockComponentRegistry.registerCustomComponent('gaia:green_agate_log', {
        ...
        onPlayerInteract(e) {
            ...
            if (blockState) {
                const strippedLog = BlockPermutation.resolve('gaia:stripped_green_agate_log', {"minecraft:block_face": blockState});
