...
world.beforeEvents.worldInitialize.subscribe(eventData => {
    ...
    eventData.blockComponentRegistry.registerCustomComponent('gaia:burning_log', {
        ...
        onPlayerInteract(e) {
            ...
            if (blockState) {
                const strippedLog = BlockPermutation.resolve('gaia:stripped_burning_log', {"minecraft:block_face": blockState});
