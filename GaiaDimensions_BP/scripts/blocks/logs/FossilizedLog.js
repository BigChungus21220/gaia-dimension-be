...
world.beforeEvents.worldInitialize.subscribe(eventData => {
    ...
    eventData.blockComponentRegistry.registerCustomComponent('gaia:fossilized_log', {
        ...
        onPlayerInteract(e) {
            ...
            if (blockState) {
                const strippedLog = BlockPermutation.resolve('gaia:stripped_fossilized_log', {"minecraft:block_face": blockState});
