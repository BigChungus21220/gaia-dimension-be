...
world.beforeEvents.worldInitialize.subscribe(eventData => {
    ...
    eventData.blockComponentRegistry.registerCustomComponent('gaia:amethyst_slab', {
        ...
        onPlayerInteract(e) {
            ...
            if (selectedItem?.typeId === 'gaia:amethyst_slab' && !block.permutation.getState('kai:double')) {
            ...
            if (selectedItem?.typeId === 'minecraft:water_bucket' && !block.permutation.getState('block:waterlogged') && !block.permutation.getState('kai:double')) {
                ...
                const verticalHalf = block.permutation.getState('minecraft:vertical_half');
                const structureName = (verticalHalf === 'bottom') ? 'mystructure:AmethystBottomSlab' : 'mystructure:AmethystTopSlab'; // These structures contain your slab waterlogged, made with an NBT editor
        ...
        onPlayerDestroy(e) {
            ...
            if (isPickaxe) {
                const slabItem = new ItemStack('gaia:amethyst_slab', 1);
