...
class PouchManager {
    ...
    checkItemChanges() {
        ...
        for (const player of allPlayers) {
            ...
            if (itemHolding && itemHolding.typeId.includes("gaiadimension:gem_pouch") && propertyInterface.id !== undefined) {
    ...
    onChanged(player, playerInventory, propertyDataCurrent, propertyDataOld) {
        ...
        if (currentItem !== undefined) {
            if (currentItem.typeId.includes("gaiadimension:gem_pouch")) {
    ...
    createPouch(currentItem, player) {
       ...
       inv.setItem(player.selectedSlot, currentItem);
        const pouchEntity = player.dimension.spawnEntity("gaiadimension:gem_pouch_container", player.location);
